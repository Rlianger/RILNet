...
from utils.tools import read_masks, read_image, download_url, mkdir_if_missing
...
class Dataset(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.train = train  # with 'masks_path'
        self.query = query
        ...
        self.num_train_vids = self.get_num_vids(self.train)
    ...
    def parse_data(self, data):
        ...
        for i, sample in enumerate(data):
            ...
            vids.add(sample['viewid'])

        return len(pids), len(cams), len(vids)
    ...
    def __repr__(self):
        num_train_pids, num_train_cams, _ = self.parse_data(self.train)
        num_query_pids, num_query_cams, _ = self.parse_data(self.query)
        num_gallery_pids, num_gallery_cams, _ = self.parse_data(self.gallery)
