...
from data.masks_transforms import masks_preprocess_transforms
from data.sampler import build_train_sampler
from data.datasets import init_image_dataset, init_video_dataset, get_image_dataset
...
class DataManager(object):
    ...
    def __init__(
        ...
        self.transform_tr, self.transform_te = build_transforms(
            ...
            masks_preprocess=config.masks.preprocess,
            softmax_weight=config.masks.softmax_weight,
            background_computation_strategy=config.masks.background_computation_strategy,
            mask_filtering_threshold=config.masks.mask_filtering_threshold,
        )
    ...
    @property
    def num_train_vids(self):
        """Returns the number of training cameras."""
        return self._num_train_vids
    ...
    def __init__(
        ...
        for name in self.sources:
            trainset_ = init_image_dataset(
                ...
                use_masks=use_masks,
                masks_dir=masks_dir,
                load_masks=self.config.masks.preprocess in masks_preprocess_transforms,
            )
        ...
        self._num_train_vids = trainset.num_train_vids
